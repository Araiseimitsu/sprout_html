<script lang="ts">
  ...
  function runGenerate() {
    generateNewPage(generatePrompt, savePath.trim() || undefined)
  }
  function runEditAll() {
    editWholePage(editAllPrompt)
  }
  function runEditSelected() {
    editSelectedElement(editSelectedPrompt)
  }
  function runImage() {
  ...
  >
    ...
    <div class="body">
      {#if activeTab === 'generate'}
        ...
        <input class="path" bind:value={savePath} placeholder="保存先パス(任意・例: /path/to/page.html)" />
